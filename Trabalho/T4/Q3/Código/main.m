...
nvars = 1;                   %Quantidade de variáveis de projeto
x=[0.8];           %Vetor dos parâmetros de projeto
...
tdesvio=1.e-6;
starttemp=[.5];   %Temperatura incial ( é o desvio padrão da
...
xlower=[-2.0];         % limite inferior das variáveis de projeto
xupper=[2.0];   % limite superior das variáveis de projeto
